...
const images = [
  // Front
  { position: [0, 0, 1.5], rotation: [0, 0, 0], url: 'https://static01.nyt.com/images/2022/06/12/magazine/12mag-talk-03/12mag-talk-03-superJumbo.jpg', scale: [1.5, 1, 1]
  },
  // Back
  { position: [-0.8, 0, -0.6], rotation: [0, 0, 0], url: 'https://static01.nyt.com/images/2022/06/12/magazine/12mag-talk-03/12mag-talk-03-superJumbo.jpg', scale: [1, 1, 1] },
  { position: [0.8, 0, -0.6], rotation: [0, 0, 0], url: 'https://static01.nyt.com/images/2022/06/12/magazine/12mag-talk-03/12mag-talk-03-superJumbo.jpg', scale: [1, 1, 1] },
  // Left
